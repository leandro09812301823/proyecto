...
public class DATOS {
    public static void main(String[] args) {
        ...
        //Pedimos el nombre y la cantidad de articulos
        ...
        double arrayPrecio[]=new double[cantidad];
        ...
        for(int i=0;i<arrayPrecio.length & i<arrayArticulo.length;i++){
            System.out.println(arrayArticulo[i]+"               "+arrayPrecio[i]);
        }    
        System.out.println("            --------------");
        System.out.println("SUBTOTAL:               "+Ejercicio4.sTotal(arrayPrecio));
        System.out.println("IVA:                    "+Ejercicio4.iva(arrayPrecio));
        System.out.println("            --------------");
        System.out.println("TOTAL:                  "+Ejercicio4.ValorT(arrayPrecio));
