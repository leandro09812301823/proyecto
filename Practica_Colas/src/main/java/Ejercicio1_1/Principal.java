...
public class Principal {
    public static void main(String[] args){
        int menu=0;
        double Dato_Nodo=0;
        Ejercicio1_1.Cola cola=new Ejercicio1_1.Cola();
                ...
                switch(menu){
                    ...
                    case 2:
                        Dato_Nodo=Double.parseDouble(JOptionPane.showInputDialog(null,
                                "Digite la estatura a incluir en el nodo"));
                        cola.Insertar(Dato_Nodo);
                        break;
                    case 3:
                        if(!cola.ColaVacia()){
                            JOptionPane.showMessageDialog(null, "Se extrajo una estatura con el valor: "
                            +cola.Extraer());
                        }else{
